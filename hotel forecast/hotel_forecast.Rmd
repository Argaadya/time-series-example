...
If you wish to get the model or the forecasting result, just re-run the former steps using only the best adjustment. Here is one of the forecasting result for the Online TA segment of the city hotel. The actual demand is still inside the forecasting interval value.
...
data_test <- test_list$data[[3]] %>% ts(start = 3.090411, frequency = 365)
...
model_best[[6]] %>%
  ...
  labs(subtitle = "City Hotel, Online TA",
       y = "Demand", x  = NULL) +
  theme_pander() +
  scale_x_continuous(breaks = 1:3, labels = 2015:2017) +
